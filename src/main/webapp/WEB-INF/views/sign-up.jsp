...
<body>
<center><h3>Spring Boot CRUD - Trabajo final</h3></center>
     <!-- Sign up form -->
                        ...
                        <form:form modelAttribute="employee-sign-up" method="POST" action="/employee/saveEmployee" cssClass="register-form"
                         id="register-form">
                            ...
                            <div style="display: flex; justify-content: space-between;" class="form-group"> 
								...
								Femenino: <form:radiobutton path="gender" value="Female"/>
                            ...
                            <div class="form-group">
                                ...
                                <form:option value="">---Seleccione el departamento--</form:option>
	                                <form:option value="IT">IT</form:option>
	                                <form:option value="Bank">Banco</form:option>
	                                <form:option value="Yoga">Yoga</form:option>
	                                <form:option value="Business">Comercio</form:option>
	                                <form:option value="Art & Culture">Arte y cultura</form:option>
	                                <form:option value="Forest">Medio ambiente</form:option>
                                </form:select>                      
